import cryptixcore from '@cryptix/core-lib';
import { CryptixAPI } from 'wallet/apiHelpers';

export type Network = 'cryptix' | 'cryptixdev' | 'cryptixreg' | 'cryptixtest' | 'cryptixsim';
export type bytes = string;//base84 string

export * from './rpc';
import {IRPC, RPC} from './rpc';
import { CryptixAPI } from './apiHelpers';
